...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference("Calendar.count") do
      post calendars_url, params: { calendar: { background_color: @calendar.background_color, name: @calendar.name, text_color: @calendar.text_color } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { background_color: @calendar.background_color, name: @calendar.name, text_color: @calendar.text_color } }
